...
objects are then assembled into Room.glb (and Room.blend alongside it).
    ...
    python -m lrauthor.room_ops.compile.build_from_room --room Room/office-elliott
    python -m lrauthor.room_ops.compile.build_from_room --room Room/tea_room --regenerate
