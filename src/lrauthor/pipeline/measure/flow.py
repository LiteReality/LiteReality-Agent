...
Run (from the repo root):
    python -m lrauthor.pipeline.measure.flow --scan office-elliott
    python -m lrauthor.pipeline.measure.flow --scan office-elliott --skip-image-generation
    python -m lrauthor.pipeline.measure.flow --scan /abs/path/to/raw_scan --name my_room
    python -m lrauthor.pipeline.measure.flow --scan office-elliott --reconstruct
...
from lrauthor.pipeline.measure.ingest.extract import extract_scene
from lrauthor.pipeline.measure.ingest.references import (
    chair_clusters,
    object_references,
    opening_references,
)
