...
Deliberately does NOT import the harness (``lrauthor.agent.tools.shared.config`` requires ``$LITEREALITY_SCAN``);
...
from lrauthor import REPO_ROOT as _ROOT  # the checkout — the agent works from there
