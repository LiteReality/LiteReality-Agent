...
pipeline decides whether the room passes.
    ...
    python -m litereality_agent.pipeline.compile.qc.checks --room <room dir>
    python -m litereality_agent.pipeline.compile.qc.checks --layout <room_layout.json> --shell <Room.py>
"""
