...
Run (from the repo root):
    python -m litereality_agent.pipeline.measure.flow --scan office-elliott
    python -m litereality_agent.pipeline.measure.flow --scan office-elliott --skip-image-generation
    python -m litereality_agent.pipeline.measure.flow --scan /abs/path/to/raw_scan --name my_room
    python -m litereality_agent.pipeline.measure.flow --scan office-elliott --reconstruct
...
from litereality_agent.pipeline.author.reconstruct.classify import classify_complexity
from litereality_agent.pipeline.author.reconstruct.mesh_qc import chair_repair
from litereality_agent.pipeline.measure import layout
from litereality_agent.pipeline.measure import paths as config
from litereality_agent.pipeline.measure.ingest import merge_boxes
from litereality_agent.pipeline.measure.ingest.crop import crop_objects
from litereality_agent.pipeline.measure.ingest.detect import bbox_polish
from litereality_agent.pipeline.measure.ingest.extract import extract_scene
from litereality_agent.pipeline.measure.ingest.references import (
    chair_clusters,
    object_references,
    opening_references,
)
